...
#Hope You achieve what you are aiming for..Best wishes from Manoj.Thank you..

print("\t\t WELCOME TO Manoj'S LIVE FACE DETECTOR")
print("\t\t\t...Hope you will be gettng caught:)")

label_ids={}
with open("Manoj_Face_Classifier.pickle",'rb') as f:
    org=pickle.load(f) 
...
face_recognizer.read(r"Manoj_Face_classifier.xml")
